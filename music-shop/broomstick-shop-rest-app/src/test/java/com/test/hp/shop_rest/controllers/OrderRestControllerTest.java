...
//
//    @MockBean
//    private OrderService com.test.hp.service;
//
//    @Autowired
...
//        Mockito.when(com.test.hp.service.findAllOrderDTOs()).thenReturn(Arrays.asList(createDto(1), createDto(2)));
//
...
//
//        Mockito.verify(com.test.hp.service, times(1)).findAllOrderDTOs();
//    }
//
//    @Test
//    void findOrdersByDates() throws Exception{
//        Mockito.when(com.test.hp.service.findOrdersByDates(FROM, TO)).thenReturn(Arrays.asList(createDto(1), createDto(2)));
//
...
//                .andExpect(jsonPath("$[1].orderId", Matchers.is(2)));
//
//        Mockito.verify(com.test.hp.service, times(1)).findOrdersByDates(FROM, TO);
//    }
//
//    @Test
//    void findOrderById() throws Exception{
//        int id = 1;
//        Mockito.when(com.test.hp.service.findOrderById(id)).thenReturn(createOrder(id));
//
...
//
//        Mockito.verify(com.test.hp.service, times(1)).findOrderById(id);
//    }
//
//    @Test
//    void addOrder() throws Exception{
//        int id = 1;
//        Mockito.doNothing().when(com.test.hp.service).addOrder(createOrder(id));
//
...
//
//        Mockito.verify(com.test.hp.service, times(1)).addOrder(any(Order.class));
//    }
//
//    @Test
//    void updateOrder() throws Exception{
//        int id = 1;
//        Mockito.doNothing().when(com.test.hp.service).updateOrder(createOrder(id));
//
...
//
//        Mockito.verify(com.test.hp.service, Mockito.times(1)).updateOrder(any(Order.class));
//    }
//
//    @Test
//    void deleteOrder() throws Exception{
//        int id = 1;
//        Mockito.doNothing().when(com.test.hp.service).deleteOrder(id);
//
//        mock.perform(MockMvcRequestBuilders.delete("/orders/{id}", id))
//                .andExpect(status().isOk());
//
//        Mockito.verify(com.test.hp.service, Mockito.times(1)).deleteOrder(id);
//    }
//
